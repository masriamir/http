...
final class TestUtils {
	 ...
	 */
	public static void successResponseWithCode(final HttpResponse resp, final int statusCode) {
		successResponse(resp);
	...
	/**
	 * Asserts the given response represents a successful request.
	 * <p>This method does not make any assertions about the data returned.
	 * @param resp the HttpResponse
	 */
	 ...
	 * @param statusCode the expected status code
	 */
	public static void errorResponseWithCode(final HttpResponse resp, final int statusCode) {
		errorResponse(resp);
		statusCode(statusCode, resp.getStatusCode());
	}
	...
	public static void statusCode(final int expected, final int actual) {
		assertEquals(String.format("status code is not %d", expected), expected, actual);
	}
	 ...
	 */
	public static void containsHeader(final HttpResponse resp, final String header) {
		assertTrue(String.format("header %s missing from response", header), resp.getHeaders().containsKey(header));
	}
	 ...
	 */
	public static void containsHeaderWithValue(final HttpResponse resp, final String header, final String value) {
		containsHeader(resp, header);
		assertEquals(String.format("header %s does not have value %s", header, value), value, resp.getHeaders().get(header));
	}
	 ...
	 * @param value the value of the header
	 */
	public static void addHeader(final List<Header> headers, final String name, final String value) {
